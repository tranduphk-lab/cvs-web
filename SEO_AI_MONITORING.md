...
- Hub kiến thức và ba bài đã được chuẩn bị: `/kien-thuc/`, `/kien-thuc/da-dau-khi-doi-mu-bao-hiem/`, `/kien-thuc/gau-la-gi-vi-sao-de-quay-lai/` và `/kien-thuc/da-dau-dau-toc-nhanh-bet-du-moi-goi/`. Bài về da đầu dầu chỉ chuyển sang trạng thái đã xuất bản sau khi được duyệt và triển khai.
...
- Theo dõi 11 URL HTML đã xuất bản và bổ sung bài về da đầu dầu thành URL thứ 12 sau khi triển khai.
...
14. vì sao tóc nhanh bết dù mới gội
15. gội đầu nhiều có làm da đầu tiết dầu hơn không
