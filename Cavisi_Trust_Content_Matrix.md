...
|---|---|---|---|
| S1 | `TTSP - Dầu gội trị gàu_Trần Dư.docx` | Thành phần, công dụng, đối tượng, cách dùng, lưu ý, bảo quản, nơi sản xuất | Nguồn sản phẩm ưu tiên do Cavisi xác nhận là thông tin đã xin cấp phép; các trường hành chính còn trống được bổ sung từ S7 |
| S2 | `TTSP - Xịt tóc gàu_Trần Dư.docx` | Thành phần, công dụng, đối tượng, cách dùng, lưu ý, bảo quản, nơi sản xuất | Nguồn sản phẩm ưu tiên do Cavisi xác nhận là thông tin đã xin cấp phép; các trường hành chính còn trống được bổ sung từ S8 |
...
| S7 | `28338. Cavisi Shampoo.pdf` | Phiếu công bố đã tiếp nhận của Cavisi Shampoo | Dùng cho số tiếp nhận và dữ liệu hành chính không có trong TTSP; không dùng thay TTSP cho thành phần/claim theo quyết định của Cavisi |
| S8 | `28222. Cavisi Spray.pdf` | Phiếu công bố đã tiếp nhận của Cavisi Spray | Dùng cho số tiếp nhận và dữ liệu hành chính không có trong TTSP; không dùng thay TTSP cho thành phần/claim theo quyết định của Cavisi |
| S9 | `Bao bì Cavisi ok8.pdf` | Artwork hộp, nhãn và tờ hướng dẫn | Đã được Cavisi xác nhận là bản in cuối |
| U1 | Dữ liệu do Du cung cấp ngày 12/09/2026 | Số tiếp nhận phiếu công bố của hai sản phẩm | Đã được đối chiếu với S7/S8 |
| U2 | Xác nhận của Du ngày 15/09/2026 | Tên, dung tích, giá, hotline, leave-on, mã vạch, artwork, badge, hồ sơ nguyên liệu Postbiotic và quy tắc công khai | Nguồn quyết định vận hành/nội dung; xác nhận nguyên liệu Postbiotic nhập khẩu từ châu Âu có giấy tờ hợp lệ, nhưng không thay thế bằng chứng hiệu quả thành phẩm |

### Số tiếp nhận phiếu công bố đã được cung cấp

| Sản phẩm | Số tiếp nhận phiếu công bố | Nguồn | Trạng thái |
|---|---|---|---|
| Cavisi Shampoo | `28338/26/CBMP-HN` | S7/U1 | Đã đối chiếu bản phiếu trong workspace |
| Cavisi Spray | `28222/26/CBMP-HN` | S8/U1 | Đã đối chiếu bản phiếu trong workspace |
...
1. Hai tệp TTSP đã được xin cấp phép: nguồn ưu tiên cho thành phần, công dụng, đối tượng, cách dùng, lưu ý và bảo quản.
2. Phiếu công bố đã tiếp nhận: nguồn bổ sung cho số tiếp nhận, ngày, nhà sản xuất và đơn vị chịu trách nhiệm khi TTSP không có trường tương ứng.
3. Artwork `ok8` đã chốt in: nguồn cho nội dung và quy cách thực tế trên bao bì.
4. Báo cáo kiểm nghiệm, COA, chứng nhận và tài liệu nhà máy có thể kiểm tra.
5. Brand Guideline cho định vị và nhận diện.
6. Tài liệu marketing nội bộ cho cách diễn giải.
7. Nội dung website cũ và hình ảnh AI chỉ dùng làm tham khảo sáng tạo.
...
|---|---|---|---|---|
| Tên hiển thị `Cavisi Shampoo`, dung tích 250 ml | S1/S9/U2 | GREEN | Dùng đúng tên và dung tích đã chốt | Giữ nhất quán trên mọi touchpoint |
...
| Ngăn ngừa/cải thiện ngứa do gàu | S1 | AMBER | Không đưa lên homepage; chỉ cân nhắc đúng phạm vi wording TTSP và sau rà soát pháp lý | Không mở rộng thành claim điều trị |
| Ngăn ngừa/cải thiện tóc gãy, rụng | S1 | RED | Không công bố hiện tại | Cần bằng chứng phù hợp; xem xét loại khỏi định vị |
| Cho tóc chắc khỏe hơn | S1 | AMBER | Không dùng làm thông điệp chính của Cavisi | Giữ đúng wording TTSP nếu sử dụng |
| Trị gàu/chữa gàu | Tên tệp dùng từ “trị gàu”; tên hiển thị đã chốt là `Cavisi Shampoo` | RED | Dùng `làm sạch gàu` hoặc wording TTSP, không dùng `điều trị/chữa` | Không dùng tên tệp làm tên thương mại |
...
| Nội dung/claim | Nguồn hiện có | Trạng thái | Cách diễn đạt đề xuất | Việc cần làm trước launch |
|---|---|---|---|---|
| Tên hiển thị `Cavisi Spray`, dung tích 30 ml | S2/S9/U2 | GREEN | Dùng đúng tên và dung tích đã chốt | Giữ nhất quán trên mọi touchpoint |
...
| Không cần xả lại | S9/U2 | GREEN | `Không cần xả lại sau khi dùng` | Giữ nhất quán với tờ hướng dẫn và nội dung website |
| Là sản phẩm leave-on | S9/U2 | GREEN | Có thể giải thích là sản phẩm chăm sóc lưu lại trên da đầu | Không tự gắn hiệu quả hệ vi sinh đã chứng minh |
| Có nguyên liệu Postbiotic nhập khẩu từ châu Âu | S2/S9/U2 | GREEN | Có thể công khai nguồn gốc EU và gọi là nguyên liệu Postbiotic theo hồ sơ đã xác nhận | Không dùng hồ sơ nguyên liệu để suy ra hiệu quả thành phẩm |
| Hỗ trợ môi trường/hệ vi sinh da đầu cân bằng | S3/S4/S5/U2 | AMBER | Giữ ở cấp độ triết lý/cơ chế do thương hiệu xác nhận, không trình bày là kết quả thành phẩm đã chứng minh | Cần nguồn khoa học hoặc kết quả thử nghiệm thành phẩm và phê duyệt claim |
| Ngăn ngừa/cải thiện ngứa do gàu | S2 | AMBER | Không đưa lên homepage; chỉ cân nhắc đúng phạm vi wording TTSP và sau rà soát pháp lý | Không mở rộng thành claim điều trị |
| Phục hồi tóc hư tổn, ngăn ngừa gãy rụng | S2 | RED | Không công bố hiện tại | Cần bằng chứng phù hợp |
...
### Cách dùng Spray đã được xác nhận
...
`Không cần xả lại` đã được xác nhận. Wording về thời điểm dùng khi tóc còn ẩm/gần khô vẫn cần được đồng bộ giữa hộp, tờ hướng dẫn và TTSP.
...
| Shampoo rinse-off + Spray leave-on | S1/S2/S9/U2 | GREEN | Có thể dùng để giải thích quy trình hai bước; không suy rộng thành hiệu quả đã kiểm nghiệm |
| Phân loại nguyên liệu Postbiotic và nguồn gốc châu Âu | U2 | GREEN | Có thể trình bày đúng phạm vi hồ sơ nguyên liệu; không mở rộng thành claim hiệu quả sản phẩm |
...
| `European-Grade Postbiotic Ingredient` | S9/U2 | GREEN có giới hạn | Có thể nói nguyên liệu Postbiotic được nhập khẩu từ châu Âu và có giấy tờ hợp lệ; không suy diễn thành chứng nhận EU cho toàn bộ thành phẩm |
| Badge `EU STANDARD` | S9/U2; chưa có hồ sơ quyền sử dụng riêng trong workspace | AMBER/RED | Được giữ trên artwork theo quyết định thương hiệu; không diễn giải thành chứng nhận EU của thành phẩm nếu badge không có hồ sơ riêng |
...
- `Thành phần sản phẩm`: có danh sách INCI trong hai TTSP được Cavisi chỉ định làm nguồn ưu tiên.
...
- `không cần xả lại` cho Cavisi Spray
...
- claim thành phẩm đạt chuẩn/chứng nhận EU, clinical hoặc dermatologist chưa có tài liệu tương ứng

---

## 10. Trạng thái tài liệu tạo niềm tin

| Ưu tiên | Tài liệu/dữ liệu cần có | Dùng để xác minh | Trạng thái hiện tại |
|---|---|---|---|
| P0 | Bản phiếu công bố mỹ phẩm hoàn chỉnh của từng sản phẩm | Xác minh số tiếp nhận và dữ liệu hành chính | VERIFIED - đã có S7/S8; thông tin sản phẩm ưu tiên lấy từ TTSP theo quyết định của Cavisi |
| P0 | Nhãn/artwork bao bì cuối đã duyệt | Tên sản phẩm, INCI, cách dùng, cảnh báo, claim trên bao bì | VERIFIED - S9 là bản in cuối |
| P0 | TCCS hoàn chỉnh | Chỉ tiêu chất lượng và tiêu chuẩn cơ sở | MISSING |
| P0 | Thông tin thương nhân chịu trách nhiệm | Danh tính pháp nhân và kênh xác minh | VERIFIED-INTERNAL - đã biết nhưng hiện không công khai trên website |
| P0 | Xác nhận hướng dẫn Spray không cần xả lại | Cơ sở cho thuật ngữ leave-on và routine 2 bước | VERIFIED - đã xác nhận ngày 15/09/2026 |
...
| Cơ chế | Hai bước và Microbiome Care nghĩa là gì? | Narrative trong S3/S4, INCI và hồ sơ nguyên liệu Postbiotic đã xác nhận | Nguồn khoa học/kết quả thử nghiệm thành phẩm và wording claim được duyệt |
| Bộ đôi | Vai trò của Shampoo và Spray khác nhau thế nào? | Công dụng/cách dùng S1/S2; leave-on đã xác nhận | Bằng chứng cho các claim hiệu quả của hệ thống hai bước |
| Shampoo | Công thức, cách dùng, lưu ý là gì? | TTSP, phiếu công bố, artwork cuối, tên/dung tích/giá | TCCS, kiểm nghiệm và hồ sơ claim |
...
### Đã được Cavisi xác nhận ngày 15/09/2026

1. Tên hiển thị chính thức: `Cavisi Shampoo` và `Cavisi Spray`.
2. Dung tích: Shampoo 250 ml; Spray 30 ml.
3. Giá niêm yết: Shampoo 249.000 VNĐ; Spray 149.000 VNĐ; combo 359.000 VNĐ.
4. Spray là sản phẩm leave-on, không cần xả lại.
5. Hotline hiển thị chuẩn: `076 435 8668`.
6. `Bao bì Cavisi ok8.pdf` là artwork cuối được phép in.
7. Hai mã vạch trên artwork là chính thức nhưng không công khai trên website.
8. Tiếp tục dùng badge `EU STANDARD` trên artwork.
...
3. Nguồn khoa học về scalp microbiome/Postbiotic đã được chuyên môn chọn.
4. Founder story hoặc giới thiệu người phụ trách sản phẩm.
5. Chính sách phản hồi khi khách hàng có dấu hiệu kích ứng.

---

## 14. Bước triển khai kế tiếp

Trong khi chờ các hồ sơ còn thiếu, có thể bắt đầu wireframe trust-first với các nguyên tắc:
...
Website đã được đồng bộ với nhóm dữ kiện xác nhận ngày 15/09/2026. Đầu ra tiếp theo nên là kiểm tra kỹ thuật index/canonical/sitemap, sau đó xây trang **Bằng chứng & Minh bạch** mà không biến badge hoặc claim microbiome thành chứng cứ khi hồ sơ còn thiếu.
